...
- 本项目由 [GLM-5.3-Flash](https://z.ai)（智谱 ZCode 编程助手）辅助开发构建
- [BepInEx](https://github.com/BepInEx/BepInEx) 与 [HarmonyX](https://github.com/BepInEx/HarmonyX) — 运行时注入框架
...
**Acknowledgements**: built with the assistance of [GLM-5.3-Flash](https://z.ai) (ZCode coding agent); runtime injection powered by [BepInEx](https://github.com/BepInEx/BepInEx) & [HarmonyX](https://github.com/BepInEx/HarmonyX).
